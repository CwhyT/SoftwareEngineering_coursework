  ...
  <div class="container mx-auto p-4">
    ...
    <div class="mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="col-span-1 bg-white shadow rounded-lg p-4">
        <div class="flex flex-col items-center">
          <img 
            ...
            alt="User avatar"
          />
          <h2 class="text-xl font-bold">{{ userInfo.username || 'Username' }}</h2>
          <p class="text-gray-500">{{ userInfo.email || 'Email' }}</p>
          <div class="mt-4 w-full">
            <div class="flex justify-between items-center mb-2">
              <span>Balance</span>
              <span class="font-bold">¥{{ userInfo.balance || '0.00' }}</span>
            </div>
            <el-button type="primary" class="w-full" @click="showRechargeDialog">Recharge</el-button>
          </div>
        </div>
          ...
          <div class="border-t border-gray-200 pt-4">
            <div class="flex justify-between items-center mb-3">
              ...
              <el-tag :type="userInfo.vip ? 'success' : 'info'">
                {{ userInfo.vip ? 'VIP Member' : 'Regular Member' }}
              </el-tag>
            </div>
            <div class="flex justify-between items-center mb-3">
      ...
      <div class="col-span-2 bg-white shadow rounded-lg p-4">
        <h3 class="text-lg font-bold mb-4">Riding Statistics</h3>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div class="text-center p-3 bg-purple-50 rounded-lg">
            <div class="text-2xl font-bold text-purple-500">{{ rideStats.totalDuration || 0 }} minutes</div>
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="handleRecharge">Confirm Recharge</el-button>
        </span>
      </template>
    </el-dialog>
...
const handleRecharge = () => {
  ...
  setTimeout(() => {
    ...
    ElMessage({
      type: 'success',
      message: `Successfully recharged ¥${rechargeForm.amount}!`,
      duration: 2000
    });
  }, 1000);
};
...
const handleFeedbackSubmitted = () => {
  ElMessage({
    type: 'success',
    message: 'Thank you for your feedback, we will process it as soon as possible',
    duration: 2000
  });
};
