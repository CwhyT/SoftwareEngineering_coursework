        ...
        <div class="mb-6">
          <el-form-item prop="username">
            <el-input
              ...
              class="form-input"
            />
            <div class="text-xs text-gray-500 mt-1 ml-1">Username must be between 3-20 characters</div>
          </el-form-item>
          ...
          <el-form-item prop="password">
            <el-input
              ...
              show-password
            />
            <div class="text-xs text-gray-500 mt-1 ml-1">Password must be between 6-20 characters</div>
          </el-form-item>
        </div>
        
        
        
        <el-button type="primary" native-type="submit" class="w-full mt-4" :loading="loading">Login</el-button>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (result.success) {
      ...
      // 登录失败
      errorMessage.value = result.message || 'Login failed, please check your username and password';
    }
  } catch (error) {
