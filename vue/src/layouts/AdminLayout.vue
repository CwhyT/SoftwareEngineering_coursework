      ...
      <div class="px-6 py-4 border-b border-gray-800">
        <div class="flex items-center">
          ...
          <div>
            ...
            <div class="text-xs text-gray-400">电动滑板车租赁系统</div>
          </div>
        </div>
      </div>
...
<!--        <div @click="navigateTo('/admin/feedback')" class="menu-item" :class="{ 'active': isActive('/admin/feedback') }">-->
<!--          <el-icon><ChatLineRound /></el-icon>-->
<!--          <span>反馈管理</span>-->
<!--        </div>-->

<!--        <div @click="navigateTo('/admin/settings')" class="menu-item" :class="{ 'active': isActive('/admin/settings') }">-->
      ...
      <div v-if="mobileMenuOpen" class="md:hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-40">
        <div class="w-64 h-full bg-gray-900 p-4 transform transition-transform duration-300 ease-in-out">
          <div class="flex justify-between items-center mb-6">
            <div class="text-white text-lg font-semibold">管理后台</div>
...
<!--          <div @click="navigateAndCloseMobile('/admin/maintenance')" class="mobile-menu-item" :class="{ 'active': isActive('/admin/maintenance') }">-->
<!--            <el-icon><Tools /></el-icon>-->
<!--            <span>问题反馈管理</span>-->
<!--          </div>-->
...
<!--          <div @click="navigateAndCloseMobile('/admin/reports')" class="mobile-menu-item" :class="{ 'active': isActive('/admin/reports') }">-->
<!--            <el-icon><TrendCharts /></el-icon>-->
<!--            <span>数据报表</span>-->
<!--          </div>-->

<!--          <div @click="navigateAndCloseMobile('/admin/feedback')" class="mobile-menu-item" :class="{ 'active': isActive('/admin/feedback') }">-->
<!--            <el-icon><ChatLineRound /></el-icon>-->
<!--            <span>反馈管理</span>-->
<!--          </div>-->

<!--          <div @click="navigateAndCloseMobile('/admin/settings')" class="mobile-menu-item" :class="{ 'active': isActive('/admin/settings') }">-->
<!--            <el-icon><Setting /></el-icon>-->
<!--            <span>系统设置</span>-->
<!--          </div>-->
